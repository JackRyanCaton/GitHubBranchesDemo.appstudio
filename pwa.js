...
const cacheName = 'GitHubBranchesDemo-2021-09-20 15:41:10.267799'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'GitHubBranchesDemo'.length) === 'GitHubBranchesDemo') {
